...
namespace Badges
{
    ...
    {
        public Dictionary<int, List<string>> keys = new Dictionary<int, List<string>>();   //I now see that this is not needed, but it works for the instructional purposes for which it was intended
